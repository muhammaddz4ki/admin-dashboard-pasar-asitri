...
const menuItems = [
  ...
  { text: 'Subsidies', icon: <SavingsIcon />, path: '/admin/subsidies' },
  { text: 'Trainings', icon: <SchoolIcon />, path: '/admin/trainings' },
  { text: 'Posts', icon: <PostAddIcon />, path: '/admin/posts' },
  { text: 'Market Prices', icon: <AssessmentIcon />, path: '/admin/market-prices' },
];
